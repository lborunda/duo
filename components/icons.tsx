...
// Icons for Preference Conversation
export const DuoBrainIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="64" cy="64" r="56" stroke="currentColor" strokeWidth="8"/>
        <path d="M64 8C73.3533 8 82.238 12.0333 88.5 18.5M64 120C54.6467 120 45.762 115.967 39.5 109.5" stroke="currentColor" strokeWidth="8" strokeLinecap="round"/>
        <path d="M120 64C120 54.6467 115.967 45.762 109.5 39.5M8 64C8 73.3533 12.0333 82.238 18.5 88.5" stroke="currentColor" strokeWidth="8" strokeLinecap="round"/>
    </svg>
);
export const HistoryIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 9H18V18H6z" />
...
export const ArtIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 2c-2.9 0-5.8 1-8 3s-4 5-4 8c0 3.9 2.1 7 5 9s6.1 2 10 2c3.9 0 7-2.1 9-5s2-6.1 2-10c0-2.9-1-5.8-3-8s-5-4-8-3z" />
        <path d="M19.5 12c-1.2 0-2.5-1-3.5-2s-1.5-3-2.5-3-2.5 2-3.5 3-1.5 3-2.5 3" />
...
export const FoodIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M7 21h10" />
        <path d="M3 3v5c0 2.2 1.8 4 4 4h8c2.2 0 4-1.8 4-4V3" />
        <path d="M12 12v9" />
        <path d="M17 3v9" />
        <path d="M7 3v9" />
    </svg>
...
export const NatureIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 12c-3 0-5 2.5-5 5 0 1.5.5 2.8 1.5 3.5" />
        <path d="M12 12c3 0 5-2.5 5-5 0-1.5-.5-2.8-1.5-3.5" />
        <path d="M15.5 15.5c-1.5 1.5-3.5 2.5-5.5 2.5" />
        <path d="M8.5 8.5c1.5-1.5 3.5-2.5 5.5-2.5" />
    </svg>
);
